...
### חישוב גיאומטרי (תוכנית 3.3)

```
רוחב מבנה (BW)     = 9.9 − 2.9 = 7.0 מ'
עומק מבנה (BD)     = 12.3 − 4.8 = 7.5 מ'  (עד תחילת ממ"ד)
רצועה עליונה       = 9.9 × 4.8 ≈ 47.5 מ"ר בנייה חדשה (יחידה 2)
זנב ימני לבנייה    = (2.9 − 1.0 שביל) × 7.5 ≈ 14.3 מ"ר (יחידה 3, עד ממ"ד)
```

> **הבהרה:** 12.3 מ' = האורך הקצר של השטח **כולל המבנה**, בחלק שרוחבו 3.17 מ' עד תחית הממ"ד.  
> 15.6 מ' = אורך הגדר בזנב הארוך **מאז רמת הממ"ד** — לא עומק המבנה.
